  ...
  */
  ...
  static string symbolic2tex(const symbolic & mys,GIAC_CONTEXT){
    ...
    if (mys.sommet==at_unit)
      return texprintsommetasoperator(feu,"\\_",contextptr);
...
#if defined USE_GMP_REPLACEMENTS || defined GIAC_GGB || defined EMCC || defined EMCC2 || defined KHICAS || defined NSPIRE_NEWLIB || defined GOODNOTES || defined ESP_PLATFORM
