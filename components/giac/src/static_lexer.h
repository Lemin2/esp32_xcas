...
/* removed FP (no definition on ESP) */
...
/* removed IP (no definition on ESP) */
...
/* removed assert (no definition on ESP) */
...
/* removed bin (no definition on ESP) */
{"binomial",13,9,0,*((ulonglong *) at_binomial)},
...
/* removed bool (no definition on ESP) */
...
/* removed clique_stats (no definition on ESP) */
...
/* removed convex (no definition on ESP, optimization.cc dropped) */
...
/* removed euler_lagrange (no definition on ESP, optimization.cc dropped) */
...
/* removed hex (no definition on ESP) */
...
/* removed igamma (no definition on ESP) */
...
/* removed is_inside (no definition on ESP) */
...
/* removed jacobi_equation (no definition on ESP, optimization.cc dropped) */
...
{"lntologb",13,9,0,*((ulonglong *) at_lntologb)},
...
/* removed regroup (no definition on ESP) */
{"rem",13,9,0,*((ulonglong *) at_rem)},
...
/* removed ugamma (no definition on ESP) */
